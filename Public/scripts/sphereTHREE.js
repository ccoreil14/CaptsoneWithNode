 ...
 var mainGeometry = new THREE.SphereGeometry(20, 64);
 ...
 function resetCanvas() {
     ...
     mainGeometry = new THREE.SphereGeometry(radius, 64);
...
//         console.log("yo");
 ...
 function updateFormulas() {
     ...
     document.getElementById("SphSurfAreaAnsr").innerText = sphereSurfaceArea(rInput.value);
     document.getElementById("SphVolAnsr").innerText = sphereVolume(rInput.value);
